...
public class InvitedEntrantsAdapter extends
    ...
    /** Called by Activity once startDate is loaded from Firestore */
    ...
    public void onBindViewHolder(@NonNull EntrantViewHolder holder, int position) {
        holder.bind(list.get(position), eventStartDate, cancelListener);
    }
    ...
    static class EntrantViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(
            ...
            Date today = new Date();
            boolean canCancel = eventStartDate != null && !today.before(eventStartDate);
